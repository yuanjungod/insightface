...
parser.add_argument('--model', default='/Users/happy/Downloads/gamodel-r50/model,0000', help='path to load model.')
parser.add_argument('--ga-model', default='/Users/happy/Downloads/gamodel-r50/model,0000', help='path to load model.')
